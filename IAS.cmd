...
::
::   Creator: WindowsAddict (https://github.com/WindowsAddict)
::   
::	 Maintained by: Jcrist Vincent Orhen (https://github.com/jcrvnx)
::
::
::============================================================================
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/jcrvnx/idm-activation & start %mas%/idm-activation-script & exit /b)
)
)
...
echo:
echo:
echo:                IDM Activation Script (IAS) by jcrvnx     
